...
const page = () => {
  ...
  return (
    ...
    <div className='w-2xl border p-3 rounded-sm'>
     ...
     <div className='flex items-center justify-around space-x-12'><h2 className='font-bold text-left'>Name</h2> <h1 className='text-2xl font-semibold text-left'>{fetchUserByIdState?.name}</h1></div>
     ...
     <div className='flex items-center justify-around space-x-12'><h2 className='font-bold text-left'>Enrollment Number</h2> <h1 className='text-md font-semibold text-left'>{fetchUserByIdState?.enrollmentNumber}</h1></div>
