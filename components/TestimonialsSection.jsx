...
const TestimonialsSection = () => {
    ...
    return (
       ...
       <div className='flex items-center justify-center flex-col'>
           <Badge className='text-md font-semibold bg-blue-700/80 border-blue-700' >Testimonials</Badge>
              <h5 className="text-4xl md:text-7xl font-medium max-w-[850px] p-2 text-center mx-auto mt-8">
      Don't just take our words
    </h5>

    <p className="text-sm md:text-base mx-auto max-w-2xl text-center mt-6 max-md:px-2">Hear what our users say about us. We're always looking for ways to improve. If you have a positive experience with us, leave a review.</p>
       </div>
            <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative">
                <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-[#f0f4f9] to-transparent"></div>
                <div className="marquee-inner flex transform-gpu min-w-[200%] pt-10 pb-5">
                    {
                        [...cardsData,...cardsData]?.map((e, index) => (

                            <div key={index} className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
                                <div className="flex gap-2">
                                    <img className="size-11 rounded-full" src={e.image} alt="User Image" />
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-xs text-slate-500">{e.handle}</span>
                                    </div>
                                </div>
                ...
                <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none bg-gradient-to-l from-[#f0f4f9] to-transparent"></div>
            </div>
