    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2 w-full">
          ...
          <ParticleCard
  key={index}
  className={`${baseClassName} relative flex flex-col justify-between overflow-hidden rounded-xl bg-white dark:bg-neutral-900 shadow-md transition-all duration-300 hover:shadow-lg`}
  style={{
    ...cardStyle,
...
>
  ...
  {/* Video Section */}
  {card?.videoSrc && (
    <div className="relative w-full flex justify-center items-center  rounded-md overflow-hidden p-2">
      <video
        src={card.videoSrc}
        muted
        loop
  ...
  {/* Text Content */}
  <div className="card__content flex flex-col p-4 gap-2 relative z-20">
    <h3
      className={`card__title font-semibold text-lg text-neutral-800 dark:text-neutral-100 leading-tight ${
    ...
    <p
      className={`card__description text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed ${
